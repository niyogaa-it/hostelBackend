...
router.post("/", async (req, res) => {
  try {
    ...
    if (req.body.SFname == undefined || req.body.SFname == "") {
      ...
      return res.json({ status: 401, message: "Please enter Student type" });
    } else if (
      ...
      return res.json({
       ...
       var isEmailAlreadyExist = await knex("student_details")
          .where({
      ...
      if (isEmailAlreadyExist.length > 0) {
        return res.json({
          status: 401,
          message: "Student already exists for this Academic Year",
        });
      }
      ...
      var isAlreadyExist = await knex("student_details")
        .where({
      ...
      let registerPlan = await knex("plan")
        .where({ id: 6 })
        .limit(1);
      ...
      var isSaveData = await knex("student_details").insert([
        {
          ...
          parking_name: "",
          parking_id: 0,
          plan_id: registerPlan[0].id,
          term: registerPlan[0].id,
          is_approved: 0,
          status: 0,
      ...
      if (isSaveData.length == 1) {
        ...
        let studentParams = {
          ...
          term: registerPlan[0].id,
          meal_type: req.body.food_preference,
          bed_type: "NULL",
          parking_type: req.body.parking == "Yes" ? req.body.parking_type : null,
          total: req.body.hasOwnProperty("payment_amount") ? req.body.payment_amount : registerPlan[0].plan_price,
          total_one_time: req.body.hasOwnProperty("payment_amount") ? req.body.payment_amount : registerPlan[0].plan_price,
          to_pay: req.body.hasOwnProperty("payment_amount") ? req.body.payment_amount : registerPlan[0].plan_price,
          paid: 'No',
          created_at: moment()
            .utcOffset("+05:30")
        ...
        let student_plan_dtl = await knex("student_plan").insert([studentParams]);
        ...
        let student_dtl = await knex("student_details").where({
          id: isSaveData[0]
        });


        let plan_dtl = await knex("student_plan").where({
          id: student_plan_dtl[0]
        });

        return res.status(200).json({
          status: 200,
          message: "Submitted successfully",
          student_dtl : [...student_dtl ,...plan_dtl]
...
router.post("/check_validation", async (req, res) => {
  try {
    ...
    if (req.body.SFname == undefined || req.body.SFname == "") {
      ...
      var isAlreadyExistEmail =  await knex("student_details")
          .where({
            AcademicYear: req.body.AcademicYear,
            StudEmail: req.body.StudEmail
          })
...
router.get("/download_application_form/:id", async (req, res) => {
  ...
  if (studentDetails.length > 0) {
    ...
    let academicYear = studentDetails[0].AcademicYear.trim(); // remove extra space
    let shortYear = academicYear
        .split('-')
    ...
    let file = {
      ...
      <tbody>
          <tr>
              <td style='border-bottom: 1px solid #000000;'>
                  <table border='0' width='100%'>
                      ...
                      <tr>
                          <td  style='padding:0;text-align: center; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 10px; '>No. 25, Ethiraj Salai,  Egmore Chennai - 600 008. Phone: 2827 1617, 2823 2009</td>
                      </tr>
                      <tr>
          ...
          <tr>
              <td style='padding: 0 0 15px;'><strong>No:</strong> RMH/${shortYear}/${req.params.id} </td>
          </tr>
          <tr>
              <td>
                  <table border='0' width='100%'>
                      ...
                      <tr>
                          <td style='padding: 5px 0; width: 40%; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 10px; font-weight: bold;'>3.Blood Group</td>
                          <td style='padding: 5px 0; width: 60%; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 12px; font-weight: normal;'>: ${
                            studentDetails[0].blood_grp
                          }</td>
                      </tr>

                      <tr>
                          <td style='padding: 5px 0; width: 40%; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 10px; font-weight: bold;'>4.Details of College enrolled in</td>
                          <td style='padding: 5px 0; width: 60%; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 12px; font-weight: normal;'></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                          <td style='padding: 5px 0; width: 40%; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 10px; font-weight: bold;'>5.Course enrolled/Year</td>
                          <td style='padding: 5px 0; width: 60%; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 12px; font-weight: normal;'>: ${
                            studentDetails[0].CourEnrolled
                          }/${studentDetails[0].AcademicYear}</td>
                      </tr>
                      <tr>
                          <td style='padding: 5px 0; width: 40%; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 10px; font-weight: bold;'>6.Details of Parents</td>
                          <td style='padding: 5px 0; width: 60%; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 12px; font-weight: normal;'>
                              <table border='0' width='100%'>
                                  <tr>
        ...
        studentDetails[0].BankBranch
                      ...
                      <tr>
                          <td style='padding: 5px 0; width: 40%; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 10px; font-weight: bold;'>7. Annual Income of Parents</td>
                          <td style='padding: 5px 0; width: 60%; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 12px; font-weight: normal;'>: ${
                      ...
                      <tr>
                          <td style='padding: 50px 0px 5px; width: 40%; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 10px; font-weight: bold;'>8. Name, Address & Phone no. of Guardian*</td>
        ...
        studentDetails[0].LocGurdConNo
          ...
          <tr>
              <td>
                  <table border='0' width='100%'>
                      <tr>
                          <td style='padding: 15px 0 0; width: 50%; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 10px; font-weight: bold;'>9. Name of the Visitors to be allowed</td>
          ...
          <tr>
              <td style='padding: 5px 0; width: 40%; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 10px; font-weight: bold;'>10. Name, Address of people in Chennai with whom the applicant can stay for weekends.</td>
          </tr>
          <tr>
              <td>
                  <table border='0' width='100%'>
          ...
          <tr>
              <td style='padding: 15px 0 0; width: 40%; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;font-size: 10px; font-weight: bold;'><strong>11. * Specify your room preference :</strong> 2 in 1 - AC - Attached Washroom </td>
          </tr>
          <tr>
              <td>
                  <table border='0' width='100%'>
...
router.get("/academic_year_list", async (req, res) => {
  ...
  const registerPlan = await knex("plan")
  .where({ id: 6 })
  .limit(1);
     ...
     return res.json({
         ...
         register_plan_data: registerPlan
     })    
});
