...
const { editStudentMail } = require("../../module/mail");
const fs = require("fs");
    ...
    //  }
      ...
      if (isSaveData) {
        ...
        await knex("student_details_image")
          ...
          if(studentDetail[0].status==0){
            editStudentMail(
              "Update Notice of  Non-approved Students",
              `<div>
              ...
              <div>
                  ...
                  This is to inform you that the student ${ studentDetail[0].SFname} data has been updated. Please visit the <a href=http://65.2.49.91:6890/admin/view_student_profile/${ req.body.id}>View</a> option to get more details
              </div>
              <br/>
            ...
            editStudentMail(
              "Update Notice of Approved Students",
              `<div>
