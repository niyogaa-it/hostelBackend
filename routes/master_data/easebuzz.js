        ...
        if (paymentDetails.status === "success") {
            ...
            if (req.body.productinfo) {
                ...
                if (existingPayment.length > 0) {
                    ...
                    if(existingPayment[0].plan_type ==='Registration'){
                    ...
                    const existingActivity = await knex("payment_activity")
                        ...
                        const updateQuery = knex("student_plan")
                            ...
                            .update({
                                paid: "Yes",
                                admin_update_payment_date: moment().utcOffset("+05:30").format("YYYY-MM-DD HH:mm:ss"),
                    ...
                    let generate_pdf = await invoiceGeneration(existingPayment[0].id);
                }
