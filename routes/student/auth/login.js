    ...
    if (selectedRows.length == 0) {
      ...
      return res.json({
        ...
        sentSms({
          ...
          msg: "Dear Ms. "+selectedRows[0].SFname+", "+otp+" is your OTP for logging in. The OTP is valid for the next 5 minutes . Please do not share it with anyone. The hostel does not ask you to share OTP. - RMHostel",
        });
